    ...
    public abstract class ThreadSafeNestedContructorsBaseSingleton<T>
    {
        ...
        internal static class SingletonFactory
        {
            ...
            public static T CreateInstance(Type type)
            {
                ...
                type.GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic, null, Array.Empty<Type>(), Array.Empty<ParameterModifier>());
                ...
                try
                {
                    return Instance = (T)nonPublicConstructor.Invoke(Array.Empty<object>());
                }
                catch (Exception e)
                {
                    throw new Exception(
